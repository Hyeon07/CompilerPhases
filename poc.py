...
def GUI():
	...
	label.config(font=("Arial",20),background="#219ebc")
	label.pack()
	lab=tk.Label(win,text="Compiler Design Project",font=("Arial",15),background="#219ebc").place(x=500,y=600)
	...
	win.mainloop()
#Show Output and its results in Listbox
def ShowOutput():
	frame=tk.Frame(win,bd=3,background="#219ebc")
	tk.Label(win,text="Parsed Strings",font=("Arial",15),background="#219ebc").place(x=250,y=70)
	...
	Tokenization() #it wil call symbol table after intializing the tokenization
	OperatorCodeGeneration() # call operator code generation
	CodeGeneration() #Machine Code Generation call 
...
def SymbolTable(identifers):
	frame=tk.Frame(win,bd=3,background="#219ebc")
	LB=Listbox(frame,font=("Arial",40),background="#219ebc")
	tk.Label(win,text="Symbol Table",font=("Arial",15),background="#219ebc").place(x=600,y=70)
	scrollx=tk.Scrollbar(frame,orient=HORIZONTAL)
	scrolly=tk.Scrollbar(frame)
	LB=tk.Listbox(frame,font=(40),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set,width=30)
	scrollx.config(command=LB.xview)
...
def CodeGeneration():	
	frame=tk.Frame(win,bd=3,background="#219ebc")
	tk.Label(win,text="Machine Code Generation",font=("Arial",15),background="#219ebc").place(x=250,y=320)
	scrollx=tk.Scrollbar(frame,orient=HORIZONTAL)
	scrolly=tk.Scrollbar(frame)
	LB=tk.Listbox(frame,font=(40),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set,width=30)
	scrollx.config(command=LB.xview)
...
#convert * into X and /into mathemtical divide operator
def OperatorCodeGeneration():
	frame=tk.Frame(win,bd=3,background="#219ebc")
	tk.Label(win,text="Mathemtical Expression Generation",font=("Arial",15),background="#219ebc").place(x=950,y=320)
	scrollx=tk.Scrollbar(frame,orient=HORIZONTAL)
	scrolly=tk.Scrollbar(frame)
	LB=tk.Listbox(frame,font=(40),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set,width=30)
	scrollx.config(command=LB.xview)
...
def Semantic():
	frame=tk.Frame(win,bd=3,background="#219ebc")
	tk.Label(win,text="Semantic Analysis",font=("Arial",15),background="#219ebc").place(x=600,y=320)
	scrollx=tk.Scrollbar(frame,orient=HORIZONTAL)
	scrolly=tk.Scrollbar(frame)
	LB=tk.Listbox(frame,font=(40),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set,width=30)
	scrollx.config(command=LB.xview)
